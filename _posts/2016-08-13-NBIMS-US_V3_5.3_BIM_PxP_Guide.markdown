...
* Post to [GitHub](https://github.com) Where editing, commenting and versions can be managed for updates. As changes are made in GitHub and commited they are automatically viewable using [Jekyll.](https://jekyllrb.com)
