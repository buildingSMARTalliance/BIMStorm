...
*
NOTE: This is a test of using GitHub to manage standards development and documentation. This test took 10 minutes to export from PDF to [WORD](https://github.com/thomas-dalbert/BIM/blob/gh-pages/_files/NBIMS-US_V3_5.3_BIM_PxP_Guide.docx) to Markdown format into GITHUB and then automatically post to the HTML page. Not all formatting is complete, such as bullets etc. The original PDF document is available for download from buildingSMARTalliance [here](https://www.nationalbimstandard.org/).
*
