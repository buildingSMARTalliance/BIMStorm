...
* Post to [GitHub](https://github.com) Where editing, commenting and versions can be managed for updates. As changes are made in GitHub and commited they are automatically viewable using [Jekyll.](https://github.com/jekyll/jekyll)
...
* Test initiated by Kimon Onuma, Chair of Thought Leadership - buidlingSMARTalliance 8.13.16 - Input Welcome!
...
_note: removed page numbers in this version_
